...
import datetime
from extractorClass import ContextExtractor  # Assuming this is your custom class
import traceback
...
if __name__ == "__main__":
    app.run(debug=True, host='0.0.0.0', port=int(os.environ.get('PORT', 5000)), ssl_context=None)